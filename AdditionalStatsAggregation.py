...
with open("data_filtered/Filtered_NonMalicious_Records_Detailed_FTX.csv", mode = "r", encoding = "ISO-8859-1") as file:
...
with open("data_filtered/Filtered_NonMalicious_Records_Detailed_CloseNetwork.csv", mode = "r", encoding = "ISO-8859-1") as readFile, \
    open("data_filtered/Filtered_NonMalicious_Records_Detailed_FTX.csv", mode = "a", newline="") as writeFile:
