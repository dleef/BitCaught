...
with open("data_filtered/Filtered_Malicious_Records_BitcoinHeist.csv", mode = "r", encoding = "ISO-8859-1") as readFile, \
    open("data_filtered/Filtered_Malicious_Records_BitcoinHeist_CloseNetwork.csv", mode = "a", newline="") as writeFile:
